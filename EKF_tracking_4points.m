...
h4=c*(Xpredit(1:2)-Mk4)/(norm(Xpredit(1:2)-Mk4)) ;
...
Ypredit=c*[norm(Xpredit(1:2)-Mk1);norm(Xpredit(1:2)-Mk2);norm(Xpredit(1:2)-Mk3);norm(Xpredit(1:2)-Mk4)];
...
Yk=[c*norm(trajectoire(:,l)-Mk1)+n1 ; c*norm(trajectoire(:,l)-Mk2)+n2 ; c*norm(trajectoire(:,l)-Mk3)+n3; c*norm(trajectoire(:,l)-Mk4)+n4] ;%Yk(n)
...
u4(:,l) = (trajectoire(:,l)-Mk4)'*(trajectoire(:,l)-Mk4);
...
RSB = 10*log10(c*sum(u1+u2+u3)/(4*length(trajectoire)*sigmav))
