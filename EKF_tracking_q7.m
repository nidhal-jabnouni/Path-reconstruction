...
% 4 (calculer A*Xi)
d1 = norm(Xpredit(1:2)-Mk1);
tmp1 = c*(2*Xpredit(1:2))/(norm(Xpredit(1:2))) ;
tmp2 = c*(2*Xpredit(1:2)-Mk2-Mk1)/(norm(Xpredit(1:2)-Mk2)-d1) ;
tmp3 = c*(2*Xpredit(1:2)-Mk3-Mk1)/(norm(Xpredit(1:2)-Mk3)-d1) ;
...
var_sortie=h'*Mpredit*h+sigmav^2*[0 0 0; 0 2 1; 0 1 2];
